...
REZSYSTEMHOME=$OPENSHIFT_REZSYSTEM_DIR
...
REZSYSCMD="java -javaagent:newrelic/newrelic.jar -classpath $CLASSPATH -DIPAddress=127.8.51.129 -DListen.port=16500 com.newrelic.airline.reservations.Main"
